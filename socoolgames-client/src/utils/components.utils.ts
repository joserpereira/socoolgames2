...
import blocks4CardsData from '@/components/admin/cms/pageBuilder/block4CardsData';

const components = [blockHeroData, blockTextData, block4ColumnsData, blocks4CardsData]
