<template>
    <section :class="'bg-gradient-to-r1 from-green-100 to-green-200 py-20 md:bg-[url('+formatUrl(baseUrl+(item?.backgroundImage?.[props.selectedLang]?.large || props.data?.backgroundImage.large))+')] bg-[url('+formatUrl(baseUrl+(item?.backgroundImage?.[props.selectedLang]?.medium || props.data?.backgroundImage.medium))+')] bg-cover' "  >
